...
set(PLUGIN_NAME "LoyalityCard")
set(PLUGIN_PREFIX "FBTP")
set(COMPANY_NAME "FBDevTeam")

# ActiveX constants:
set(FBTYPELIB_NAME LoyalityCardLib)
set(FBTYPELIB_DESC "LoyalityCard 1.0 Type Library")
set(IFBControl_DESC "LoyalityCard Control Interface")
set(FBControl_DESC "LoyalityCard Control Class")
set(IFBComJavascriptObject_DESC "LoyalityCard IComJavascriptObject Interface")
set(FBComJavascriptObject_DESC "LoyalityCard ComJavascriptObject Class")
set(IFBComEventSource_DESC "LoyalityCard IFBComEventSource Interface")
set(AXVERSION_NUM "1")
...
set(MOZILLA_PLUGINID "@firebreath.googlecode.com/LoyalityCard")
...
set(FBSTRING_ProductName "LoyalityCard")
set(FBSTRING_PluginName "LoyalityCard")

#these should be lists if we are going to support multiple MIME types:
# x-cardmgr is main plugin, x-cardmgr-math is math object from main plugin, x-fbtestmathplugin is math plugin
set(FBSTRING_MIMEType
    "application/x-cardmgr"
    "application/x-cardmgr-math"
    "application/x-fbtestmathplugin"
    )
set(ACTIVEX_PROGID
    "FBDevTeam.LoyalityCard"
    "FBDevTeam.LoyalityCard_Math"
