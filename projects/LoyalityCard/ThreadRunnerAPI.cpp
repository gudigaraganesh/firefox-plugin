...
ThreadRunnerAPI::ThreadRunnerAPI(const FB::BrowserHostPtr& host, const LoyalityCardWeakPtr& plugin)
...
LoyalityCardPtr ThreadRunnerAPI::getPlugin()
{
    LoyalityCardPtr ptr(m_plugin.lock());
    if (!ptr) {
